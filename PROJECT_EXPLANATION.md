# WordLens - Project Explanation & Interview Guide

This document is designed to help you explain the **WordLens** project in an interview setting. It breaks down the purpose, the technology stack, the architecture, and the specific challenges solved during development.
...
**A:** I built **WordLens**, an intelligent PDF reading web application designed for language learners and avid readers. 
The core problem it solves is the friction of encountering unknown words while reading. Instead of switching tabs to Google a word or use a separate dictionary app, WordLens allows users to simply click or highlight any word directly inside the PDF. It instantly pops up the definition, phonetic pronunciation, and audio playback. Users can also translate the word into multiple languages and save it to their personal "Vocabulary Library" for later review. It also tracks reading history so you can pick up exactly where you left off.
...
**A:** I built WordLens using a modern, lightweight, and highly performant stack:
...
**A:** I designed WordLens to be installable like a native app. 
